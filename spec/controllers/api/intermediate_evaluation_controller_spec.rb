...
RSpec.describe Api::IntermediateEvaluationController do
  ...
  describe 'PATCH update' do
    context 'when user is signed in' do
      ...
      context 'with valid data' do
        let(:intermediate_evaluation_attrs) { FactoryBot.attributes_for(:intermediate_evaluation, group_id: group.id) }
        let(:params) { {id: intermediate_evaluation.id, student_id: student.id, group_id: group.id, intermediate_evaluation: intermediate_evaluation_attrs, format: :json} }
      ...
      context 'with opposite dates' do
        let(:intermediate_evaluation_with_opposite_dates_attrs) { FactoryBot.attributes_for(:intermediate_evaluation, starting_month: Date.current.next_month, ending_month: Date.current, group_id: group.id, student_id: student.id) }
        let(:params) { {id: intermediate_evaluation.id, student_id: student.id, intermediate_evaluation: intermediate_evaluation_with_opposite_dates_attrs , format: :json} }
      ...
      context 'with invalid student id' do
        let(:intermediate_evaluation_attrs) { FactoryBot.attributes_for(:intermediate_evaluation, group_id: group.id) }
        let(:params) { {id: intermediate_evaluation.id, student_id: -1, group_id: group.id, intermediate_evaluation: intermediate_evaluation_attrs, format: :json} }
      ...
      context 'with invalid group id' do
        ...
        let(:params) { {id: intermediate_evaluation.id, student_id: student.id, intermediate_evaluation: intermediate_evaluation_attrs, format: :json} }
